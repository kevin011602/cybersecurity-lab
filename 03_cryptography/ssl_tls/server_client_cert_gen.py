...
2. generare certificati su server col comando: python3 server_client_cert_gen.py gen_certs
    ...
    Su Lubuntu
    wget http://192.168.188.130:8000/ca_cert.pem
    wget http://192.168.188.130:8000/client_key.pem
    wget http://192.168.188.130:8000/client_cert.pem

3. copiare sul client i files: ca_cert.pem, client_cert.pem e client_key.pem

4. avviare il server col comando: python3 server_client_cert_gen.py server 192.168.188.130 (ip del server)

5 avviare il client col comando: python3 server_client_cert_gen.py client 192.168.188.130 (ip del server)
